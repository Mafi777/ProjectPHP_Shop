...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Products SET name='$name', group_name='$group_name', price='$price', quantity='$quantity' WHERE id='$id'";

    if ($conn->query($sql) === TRUE) {
        echo "Данните за продукта са актуализирани успешно";
...
<form method="post" action="">
    ...
    <input type="text" id="group_name" name="group_name" value="<?php echo $group_name; ?>"><br><br>
